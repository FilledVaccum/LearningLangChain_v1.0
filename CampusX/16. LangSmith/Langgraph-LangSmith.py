...
@traceable(name='evalaute_language_fn', tags=['dimension:language'], metadata = {'dimension' : 'language' })
def evaluate_language(state : Essay):
    prompt = (
...
@traceable(name='evaluate_analysis_fn', tags=['dimension:clarity'], metadata={'dimension':'analysis'} )
def evaluate_analysis(state: Essay):
    prompt = (
...
@traceable(name='evalaute_thought_fn', tags=["dimension:clarity"], metadata= { 'dimension':'calrity_of_thought' } )
def evaluate_thought(state: Essay):
    prompt = (
...
@traceable(name='final_evaluation_fn', tags=['aggregated'])
def final_evaluation(state : Essay):
    prompt = (
